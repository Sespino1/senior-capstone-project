...
public class AllEventsDisplayActivity extends AppCompatActivity implements View.OnClickListener {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot child: dataSnapshot.getChildren()){
                    for(DataSnapshot kid: child.getChildren()){
                        Event event = kid.getValue(Event.class);
                ...
                if(eventList != null) {
                    adapter = new listViewAdapter(AllEventsDisplayActivity.this, R.layout.listviewadapter, eventList);
